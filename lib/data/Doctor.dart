...
import 'package:health_providers/presentation/pages/doctor_info.dart';
...
class Doctor {
  ...
  Doctor(this.username, this.email, this.password, this.context);
  ...
  void doUserLogin() async {
    ...
    if (response.success) {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => DoctorInfo()));
    } else {
